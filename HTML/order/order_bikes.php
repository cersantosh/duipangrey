...
$body = "Please contact the client as soon as possible.\n Email : $login_email \n Phone Number : $client_phone_number";
$headers = "From: '$login_email'";




$sql_count = "select * from order_bikes where bikes_id = '$id' and email = '$login_email'";
...
if ($no_of_rows == 0) {
    $sql_request_order = "insert into order_bikes(bikes_id, email) values('$id', '$login_email')";
    $result_request_order = mysqli_query($con, $sql_request_order) or die("Query Failed !");
    mail($to_email, $subject, $body, $headers);
}
// header("location:http://localhost/project/html/view_bikes_order.php");
