...
// getting all data equal to user search value
// this global variable is ignoring space so ^ is passed from js and removing it here
$search_value = $_GET['search_value'];
$search_value = str_replace("^", "", $search_value);
// print($search_value);
// print(strlen($search_value));
$search_value_lower = strtolower($search_value);
$_SESSION['search_value'] = $search_value_lower;

$sql_bikes = $_SESSION['filter_sql_bikes'];
$sql_scooters = $_SESSION['filter_sql_scooters'];
...
// showing all bikes if user input is bikes or bike
if ($search_value_lower == "bikes" || $search_value_lower == "bike") {
    $sql_scooters = "select * from sell_scooters where tole = 'jkllfd*(77'";
} else {
    // if user directly click on the bikes of filter section
    if ($sql_bikes == "select * from sell_bikes") {
        $sql_bikes = $sql_bikes . " where (company_name like '%$search_value%' or model like '%$search_value%' or cc like '%$search_value%' or km_run like '%$search_value%' or lot_number like '%$search_value%' or fuel_capacity like '%$search_value%' or original_price like '%$search_value%' or new_price like '%$search_value%' or district like '%$search_value%' or city like '%$search_value%' or tole like '%$search_value%' or additional_details like '%$search_value%' or keywords like '%$search_value%')";
    } else {

        $sql_bikes = $sql_bikes . " and (company_name like '%$search_value%' or model like '%$search_value%' or cc like '%$search_value%' or km_run like '%$search_value%' or lot_number like '%$search_value%' or fuel_capacity like '%$search_value%' or original_price like '%$search_value%' or new_price like '%$search_value%' or district like '%$search_value%' or city like '%$search_value%' or tole like '%$search_value%' or additional_details like '%$search_value%' or keywords like '%$search_value%')";
    }
...
// showing all scooters if user input is scooters or scooter
if ($search_value_lower == "scooters" || $search_value_lower == "scooter") {
    $sql_bikes = "select * from sell_bikes where tole = 'jkllfd*(77'";
} else {
    if ($sql_scooters == "select * from sell_scooters") {
        $sql_scooters = $sql_scooters . " where (company_name like '%$search_value%' or model like '%$search_value%' or cc like '%$search_value%' or km_run like '%$search_value%' or lot_number like '%$search_value%' or fuel_capacity like '%$search_value%' or original_price like '%$search_value%' or new_price like '%$search_value%' or district like '%$search_value%' or city like '%$search_value%' or tole like '%$search_value%' or additional_details like '%$search_value%' or keywords like '%$search_value%')";
    } else {

        $sql_scooters = $sql_scooters . " and (company_name like '%$search_value%' or model like '%$search_value%' or cc like '%$search_value%' or km_run like '%$search_value%' or lot_number like '%$search_value%' or fuel_capacity like '%$search_value%' or original_price like '%$search_value%' or new_price like '%$search_value%' or district like '%$search_value%' or city like '%$search_value%' or tole like '%$search_value%' or additional_details like '%$search_value%' or keywords like '%$search_value%')";
    }
}

$_SESSION['sql_scooters'] = $sql_scooters;
$_SESSION['sql_bikes'] = $sql_bikes;
...
<body>
    ...
    <div class="container">
        ...
        <div class="search_details">
            <div>
                <input type="search" placeholder="Search Bikes and Scooters" name="search_value" class="search_input" value="<?php print($search_value) ?>">
        ...
        <div class="search_result">
            <?php
            if ($total_records >= 2) {
                print("<p class='search_data'>$total_records " . "Records Found : '$search_value'</p>");
            } elseif ($total_records == 1) {
                print("<p class='search_data'>$total_records " . "Record Found : '$search_value'</p>");
            }
        ...
        <div class="filter_details">
            <form action="../filter/filter.php" method="POST">
                <div class="bikes_information_filter">
                    ...
                    <?php
                    // disabling options related to bikes if user search is scooters
                    if ($search_value_lower != "scooters" && $search_value_lower != "scooter") {
                        ...
                        <div class="products">
                            <div class="image_details">
                                ...
                                <a href="../view_details/view_details.php?id=<?php print($rows['id']) ?>&vehicle=<?php print($folder) ?>" class="link_image">
                                    ...
                                    ?>
                                        <img src="../../uploaded_images/<?php print($folder) ?>/<?php print($rows_images['image_name']) ?>" alt="" class="image">
    ...
    <?php $i++;
        ...
        print("<div class='no_products_details'><div class='no_products'> Records Not Found ! </div></div>");
    } ?>
