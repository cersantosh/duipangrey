...
if (isset($_POST['submit'])) {
    ...
    include "connection.php";
    $sql = "update sell_scooters set company_name = '$company_name', model = '$model', cc = '$cc', km_run = '$km_run', lot_number = '$lot_no', fuel_capacity = '$fuel_capacity', original_price = '$original_price', new_price = '$new_price', district = '$district', city = '$city', tole = '$tole', additional_details = '$additional_details', keywords = '$keywords' where id = '$id'";
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div>
                            <div class="image_details">
                                ...
                                while ($rows_images = mysqli_fetch_assoc($result_image)) {
                                ?>
                                    <img src="../../uploaded_images/scooters/<?php print($rows_images['image_name']) ?>" alt="" class="show_image">
                                <?php } ?>
                            </div>
                        </div>
