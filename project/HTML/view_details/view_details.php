...
<body>
    ...
    <div class="container">
        ...
        <div class="buttons">
            <button><a href="../add_to_cart/add_to_cart_<?php print($vehicle) ?>.php?id=<?php print($rows['id']) ?>&vehicle=<?php print($vehicle) ?>">Add To Cart</a></button>
            <button><a href="../order/order_<?php print($vehicle) ?>.php?id=<?php print($rows['id']) ?>&vehicle=<?php print($vehicle) ?>">Request Order</a></button>
        </div>
    </div>
