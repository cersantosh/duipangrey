...
if ($search_value_lower == "scooters" || $search_value_lower == "scooter") {
    ...
    if ($login) {
        $sql_scooters = "select * from sell_scooters where (company_name like '%$search_value%' or model like '%$search_value%' or cc like '%$search_value%' or km_run like '%$search_value%' or lot_number like '%$search_value%' or fuel_capacity like '%$search_value%' or original_price like '%$search_value%' or new_price like '%$search_value%' or district like '%$search_value%' or city like '%$search_value%' or tole like '%$search_value%' or additional_details like '%$search_value%' or keywords like '%$search_value%') and (email != '$email')";
    } else {
        $sql_scooters = "select * from sell_scooters where (company_name like '%$search_value%' or model like '%$search_value%' or cc like '%$search_value%' or km_run like '%$search_value%' or lot_number like '%$search_value%' or fuel_capacity like '%$search_value%' or original_price like '%$search_value%' or new_price like '%$search_value%' or district like '%$search_value%' or city like '%$search_value%' or tole like '%$search_value%' or additional_details like '%$search_value%' or keywords like '%$search_value%')";
    }
}
...
<body>
    ...
    <div class="container">
        ...
        <div class="filter_details">
            <form action="../filter/search_filter.php" method="POST">
