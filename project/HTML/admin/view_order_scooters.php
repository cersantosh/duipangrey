...
$sql_scooters = "select company_name, scooters_id, model, new_price, order_scooters.email as order_email, sell_scooters.email as owner_email from order_scooters join sell_scooters on scooters_id = sell_scooters.id";
                ...
                <table>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td class="remove"><button><a href="delete_scooters.php?id=<?php print($rows['scooters_id']) ?>">Delete</a></button></td>
                        </tr>
