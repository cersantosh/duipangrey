...
<body>
    ...
    <div class="container">
        ...
        while ($rows_bikes = mysqli_fetch_assoc($result_bikes)) {
            ...
            $sql_button = "select * from bikes_images where bikes_id = '$bikes_id'";
            ...
            <div class="images">
                ...
                <div>
                    ...
                    <div>
                        ...
                        ?>
                            <img src="../../uploaded_images/bikes/<?php print($rows_images['image_name']) ?>" alt="">
                    ...
                    <div>
                        ...
                        ?>
                            <button class="delete"><a href="remove_bikes_image.php?id=<?php print($rows_button['id']) ?>">Delete</a></button>
                        <?php } ?>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        // console.log(images_div[0].children[2])
