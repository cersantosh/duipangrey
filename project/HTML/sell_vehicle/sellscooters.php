...
if (isset($_POST['submit'])) {
    ...
    $sql = "insert into sell_scooters(company_name, model, cc, km_run, lot_number, fuel_capacity, original_price, new_price, district, city, tole, additional_details, keywords, email, is_scooters) values('$company_name', '$model', '$cc', '$km_run', '$lot_no', '$fuel_capacity', '$original_price', '$new_price', '$district', '$city', '$tole', '$additional_details', '$keywords', '$email', 'true')";
    ...
    foreach ($i['name'] as $key => $value) {
        ...
        $destination = "../../uploaded_images/scooters/$file_name";
        if (file_exists($destination)) {
            $file_name = time() . $file_name;
            $destination = "../../uploaded_images/scooters/$file_name";
        }
        move_uploaded_file($file_tmp_name, $destination);
        $sql_insert = "insert into scooters_images(scooters_id, image_name) values('$id', '$file_name')";
            ...
            <div class="col-sm-9 col-md-7 col-lg-5 col-xl-4 column">
                <div class="container_all">
                    ...
                    class="original_price" name="original_price"> -->
                        ...
                        <div class="submit">
                            <input type="submit" value="Add Scooters" class="submit_button" name="submit">
                        </div>
                    </form>
                </div>
            </div>
