...
// getting ordered bikes
$sql_read = "select * from order_bikes join sell_bikes on bikes_id = sell_bikes.id where order_bikes.email = '$email'";
...
<body>
    <div class="bikes_scooters">
        <button class="bikes focus_bikes"> <a href="../order/view_bikes_order.php" class="a_bikes">Bikes</a></button>
        <button class="scooters"> <a href="../order/view_scooters_order.php" class="a_scooters">Scooters</a></button>
    </div>
    <div class="container_all">
                    ...
                    <tr class="records">
                        <td class="records_td">
                            ...
                            <div>
                                <div class="image_details">
                                    ...
                                    <?php } ?>
                                    <a href="../order/view_order_details.php?id=<?php print($rows['id']) ?>&vehicle=bikes">
                            ...
                            <div class="bikes_and_buttons">
                                ...
                                <div>
                                    <div class="buttons">
                                        <button><a href="../order/view_order_details.php?id=<?php print($rows['id']) ?>&vehicle=bikes">View Details</a></button>
                                    </div>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="button_td">
                            <div class="buttons_mobile">
                                <button class="button_view"><a href="../order/view_order_details.php?id=<?php print($rows['id']) ?>&vehicle=bikes">View Details</a></button>
                            </div>
                        </td>
                    </tr>
                <?php
        ...
        <?php } else {
            print("<div class='no_products_details'><div class='no_products'> You Haven't ordered any bikes ! </div></div>");
        }
        mysqli_close($con);
        ?>
    </div>
